...
-->
    ...
    <div class="table" style="width:100%" >
        ...
        <div class="tr" style="background:#CCCCCC;">
         <div class="td" style="width:20%"><b><fmt:message key="formaListadoPaises.etiqueta.nombre" /></b></div>
        ...
        <c:forEach var="pais" items="${formaListadoPaises.paises}">
            <div class="tr">
                <div class="td" align="left" style="width:20%"><c:out value="${pais.id}"/></div>
        ...
        <div class="tr">
            <div class="td" colspan="4" align="right" style="padding-top:25px;"><b>Total:</b> ${formaListadoPais.contador}</div>
        </div>
    </div>
...
-->
    ...
    <br>
    <font size='5'><fmt:message key="formaListadoPises.titulo" /></font>
    <div class="table" style="width:100%" >
        ...
        <c:forEach var="pais" items="${formaListadoPaises.paises}">
            <div class="tr">
                <div class="td" align="left" style="width:20%"><c:out value="${pais.descripcion}"/></div>
        ...
        <div class="tr">
            <div class="td" colspan="4" align="right" style="padding-top:25px;"><b>Total:</b> ${formaListadoPises.contador}</div>
        </div>
    </div>